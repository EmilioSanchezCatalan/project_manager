...
from tfms.forms import  FilterDepartamentTfmForm
...
class DepartamentTfmListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['form_filter'] = FilterDepartamentTfmForm(
...
class DepartamentTfmDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["validation_url_ok"] = "departament_tfms_validation_ok"
        context["validation_url_error"] = "departament_tfms_validation_error"
        return context
...
@method_decorator(user_passes_test(is_departaments), name="dispatch")
class DepartamentTfmUpdateView(UpdateTfm):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if self.object.departament_validation is not None:
            ...
            return HttpResponseRedirect(reverse('departament_tfms_list'))
        return super().get(request, *args, **kwargs)

    def get_form_kwargs(self):
        kwargs = super(DepartamentTfmUpdateView, self).get_form_kwargs()
    ...
    def get_queryset(self):
        queryset = super(DepartamentTfmUpdateView, self).get_queryset()
        queryset = queryset.filter(
            tutor1__userinfos__departaments=self.request.user.userinfos.departaments,
            draft=False
        )
...
class DepartamentValidationOk(RedirectView):
    ...
    """
        Controlador para manejar la validación positiva de un TFM
    ...
    def get_redirect_url(self, *args, **kwargs):
        ...
        try:
            ...
            tfm.departament_validation = True if kwargs['validate'] == 1 else None
            tfm.save()
...
class DepartamentValidationError(RedirectView):
    ...
    def get_redirect_url(self, *args, **kwargs):
        ...
        try:
            ...
            tfm.departament_validation = False if kwargs['validate'] == 1 else None
            tfm.save()
            messages.success(self.request, "Validación realizada correctamente", "success")
