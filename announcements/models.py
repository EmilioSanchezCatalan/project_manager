...
class AnnouncementsTfg(models.Model):
    ...
    centers = models.ForeignKey(Centers, on_delete=models.CASCADE, related_name="announcementstfg", verbose_name="Centro")
...
class AnnouncementsTfm(models.Model):
    ...
    name = models.CharField(max_length=255, verbose_name="Nombre")
    status = models.PositiveSmallIntegerField(verbose_name="Estado de la convocatoria", choices=STATUS_CHOICE)
    centers = models.ForeignKey(Centers, on_delete=models.CASCADE, related_name="announcementstfm", verbose_name="Centro")
    createdAt = models.DateTimeField(auto_now_add=True, verbose_name="Fecha de creación")
    updatedAt = models.DateTimeField(auto_now=True, verbose_name="Fecha de edición")