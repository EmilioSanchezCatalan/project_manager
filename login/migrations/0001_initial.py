    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tfgs', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='students', to='tfgs.Tfgs')),
                ('tfms', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='students', to='tfms.Tfms')),
            ],
        ),
        migrations.CreateModel(
            name='Userinfos',
            fields=[
                ...
                ('auth', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='userinfos', to=settings.AUTH_USER_MODEL)),
